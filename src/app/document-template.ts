...
import {TerraAlertComponent, TerraPdfHelper} from '@plentymarkets/terra-components';
...
export class DocumentTemplate implements OnInit {
    ...
    private _githubData:Array<any> = [];
    private _templateCount:number = 0;
    ...
    public addDefaultValues(type):void {
        switch (type) {
            case 'vac':
    ...
    public printCurrentTemplate():void {
    ...
    public getAllCommitMessages(userName:string, repo:string, branchName:string, author:string):void {
